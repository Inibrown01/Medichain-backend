...
const emdexRoutes = require("./routes/emdexRoutes");
const { getIntegrationInfo } = require("./services/emdexService");
...
app.get("/health", (_req, res) => {
  res.json({
    ...
    integrations: {
      emdex: getIntegrationInfo()
    }
  });
});

app.use("/api/v1/emdex", emdexRoutes);
